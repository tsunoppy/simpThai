...
window.onload = function (){
    ...
    document.getElementById('ddtens').selectedIndex = 5;
    ...
    document.getElementById('theta').value = theta.toFixed(1);
...
var downloadAsFile = function(fileName, content) {
    ...
    textArray[5]    = document.getElementById('ddtens').selectedIndex ;
    textArray[6]    = document.getElementById('prcomp').value ;
    textArray[7]    = document.getElementById('fy').value ;
    textArray[8]    = document.getElementById('gap').value ;
    textArray[9]    = document.getElementById('theta').value ;
    textArray[10]    = document.getElementById('method').selectedIndex ;
...
function OpenFile(){
	...
	reader.onload = function(ev){
	    ...
	    document.getElementById('ddtens').selectedIndex  = textArray[5]    ;
	    document.getElementById('prcomp').value  = textArray[6]    ;
	    document.getElementById('fy').value  = textArray[7]    ;
	    document.getElementById('gap').value  = textArray[8]    ;
	    document.getElementById('theta').value  = textArray[9]    ;
	    document.getElementById('method').selectedIndex  = textArray[10]   ;
...
function OnButtonClick(){
    ...
    var ddtensName = document.getElementById('ddtens').value;
    ...
    var ddtens = pipeSec(ddtensName)[0];
    ...
    // ------------------------------------------------------------
    result += "<p> &nbsp;&nbsp;";
    result += " D<sub>b tens</sub> = ";
    result += ddtens;
    result += " mm ";
    if ( ddcomp < dd-2.0*t ) {
	result += " -> D<sub>b tens</sub> < D - 2 t ( OK ) ";
    }
    else {
	result += " -> D<sub>b tens</sub> > D - 2 t ( NG ) ";
    }
    result += "</p>";
    ...
    var gamma = dd/(2.0*t);
    var temp = Math.exp(0.5*gap/t-1.33);
    temp = 1+0.024*Math.pow(gamma,1.2)/(temp+1.0);
    var qg = Math.pow(gamma,0.2)*temp

    result += "<p>"
    result += "<h4>- For Q<sub>g</sub> </h4>";
    result += "</p>"
    ...
    result += "<p> &nbsp;&nbsp;";
    result += " Q<sub>g</sub> = &gamma;<sup>0.2</sup> [ 1 + 0.024 &gamma;<sup>1.2</sup> / ( exp( 0.5 g / t - 1.33 ) + 1 )] = ";
    result += qg.toFixed(2);
    result += "</p>";
    ...
    */
    ...
    qn = qn * ( 2.0 + 11.33 * ddcomp/dd );
    qn = qn* qg*qf /1000.0;

    result += "<p> &nbsp;&nbsp;";
    result += "Q<sub>n</sub> = ( P<sub>n</sub> sin&theta; ) = F<sub>y</sub> t<sup>2</sup> [ 2.0 + 11.33 D<sub>b comp</sub> / D ] Q<sub>g</sub> Q<sub>f</sub> = ";
    result += qn.toFixed(2);
    result += " kN";
    result += "</p>";
