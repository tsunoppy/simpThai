...
function OnLoadClick(){
    ...
    */
    ...
    document.getElementById('wtl2').innerHTML = '&nbsp; L.L/D.L = ' + (qq/gg).toFixed(2) + '&lt; 2.0';
...
function OnExeClick() {
    ...
    var m0x = wu*(ly/1000.0)*Math.pow(lx/1000.0,2)/8.0;
    var m0y = wu*(lx/1000.0)*Math.pow(ly/1000.0,2)/8.0;

    // OUTPUT
    var result = '';
    result += '<p>';
    result += '<h4> - Total Moment </h4>';
    result += '</p>';

    result += '<table><tbody>';
    result += '<tr><td>';
    result += 'For Shoter Span, &nbsp; M<sub>o</sub> = &omega;<sub>u</sub> l<sub>L</sub> l<sub>S</sub><sup>2</sup> / 8 = ';
    result += '</td><td>';
    result += m0x.toFixed(2) + "kN.m";

    result += '</td></tr><tr><td>';

    result += 'For Longer Span, &nbsp; M<sub>o</sub> = &omega;<sub>u</sub> l<sub>S</sub> l<sub>L</sub><sup>2</sup> / 8 = ';
    result += '</td><td>';
    result += m0y.toFixed(2) + "kN.m";
    result += '</td><tr>';
    result += '</tbody></table>';
    ...
    var fac = [
	[ "Interior, ", "N(+)" ,      "C/Strip, " , 0.65 , 0.75, (0.65*0.75).toFixed(2), NosForm[0], rebarForm[0] ],
	[ "Interior, ", "P(-)" ,      "C/Strip, " , 0.35 , 0.60, (0.35*0.60).toFixed(2), NosForm[1], rebarForm[1] ],
	[ "Interior, ", "N(+)" ,      "M/Strip, " , 0.65  , 0.25, (0.65*0.25).toFixed(2), NosForm[2], rebarForm[2] ],
	[ "Interior, ", "P(-)" ,      "M/Strip, " , 0.35  , 0.40, (0.35*0.40).toFixed(2), NosForm[3], rebarForm[3] ],
	[ "End span, ", "N(+)-Int." , "C/Strip, " , ff[0].toFixed(2) , 0.75, (ff[0]*0.75).toFixed(2), NosForm[4], rebarForm[4] ],
	[ "End span, ", "P(-)" ,      "C/Strip, " , ff[1].toFixed(2) , 0.60, (ff[1]*0.60).toFixed(2), NosForm[5], rebarForm[5] ],
	[ "End span, ", "N(+)-Ext." , "C/Strip, " , ff[2].toFixed(2) , 1.00, (ff[2]*1.00).toFixed(2), NosForm[6], rebarForm[6] ],
	[ "End span, ", "N(+)-Int." , "M/Strip, " , ff[0].toFixed(2) , 0.25, (ff[0]*0.25).toFixed(2), NosForm[7], rebarForm[7] ],
	[ "End span, ", "P(-)"      , "M/Strip, " , ff[1].toFixed(2) , 0.40, (ff[1]*0.40).toFixed(2), NosForm[8], rebarForm[8] ]
    ];
